...
static LCM_Init_Code init_data[] = {
	...
	{LCM_SEND(2), {0x45,0xD6}},
	{LCM_SEND(2), {0x46,0x44}},
	{LCM_SEND(2), {0x47,0x44}},
	{LCM_SEND(2), {0x52,0x00}},
	{LCM_SEND(2), {0x53,0x72}},
	{LCM_SEND(2), {0x60,0x07}},
	{LCM_SEND(2), {0x61,0x00}},
	{LCM_SEND(2), {0x62,0x08}},
	{LCM_SEND(2), {0x63,0x00}},
	{LCM_SEND(2), {0xA0,0x00}},
	{LCM_SEND(2), {0xA1,0x07}},
	{LCM_SEND(2), {0xA2,0x13}},
	{LCM_SEND(2), {0xA3,0x11}},
	{LCM_SEND(2), {0xA4,0x0A}},
	{LCM_SEND(2), {0xA5,0x16}},
	{LCM_SEND(2), {0xA6,0x08}},
	{LCM_SEND(2), {0xA7,0x07}},
	{LCM_SEND(2), {0xA8,0x03}},
	{LCM_SEND(2), {0xA9,0x08}},
	{LCM_SEND(2), {0xAA,0x05}},
	{LCM_SEND(2), {0xAB,0x03}},
	{LCM_SEND(2), {0xAC,0x0A}},
	{LCM_SEND(2), {0xAD,0x2E}},
	{LCM_SEND(2), {0xAE,0x2C}},
	{LCM_SEND(2), {0xAF,0x00}},
	{LCM_SEND(2), {0xC0,0x00}},
	{LCM_SEND(2), {0xC1,0x07}},
	{LCM_SEND(2), {0xC2,0x13}},
	{LCM_SEND(2), {0xC3,0x11}},
	{LCM_SEND(2), {0xC4,0x0A}},
	{LCM_SEND(2), {0xC5,0x19}},
	{LCM_SEND(2), {0xC6,0x0A}},
	{LCM_SEND(2), {0xC7,0x08}},
	{LCM_SEND(2), {0xC8,0x03}},
	{LCM_SEND(2), {0xC9,0x08}},
	{LCM_SEND(2), {0xCA,0x05}},
	{LCM_SEND(2), {0xCB,0x04}},
	{LCM_SEND(2), {0xCC,0x0A}},
	{LCM_SEND(2), {0xCD,0x2E}},
	{LCM_SEND(2), {0xCE,0x2B}},
...
static struct info_mipi lcd_ili9806e_mipi_info = {
	...
	.lan_number = 2,
	//.phy_feq = 500*1000, //500->10MHz,400->8M in lp mode cmntout by vixxkigoli
	.phy_feq = 420000, //500->10MHz,400->8M in lp mode
	// END
...
struct panel_cfg lcd_ili9806e_mipi = {
	...
	//.lcd_id = 0x04, cmntout by vixxkigoli
	.lcd_id = 0x04,
	// END
